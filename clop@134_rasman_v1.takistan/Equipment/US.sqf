...
//Squad	
	...
	case "TL": { // FT Leader
		...
		addMagazines("HandGrenade_West",2);
		addMagazines("SmokeShell",2);
		addWeapons ["ACE_M4A1_ACOG","ACE_CharliePack_Multicam"];
		addItems ["M","B","L"];
	...
	case "GL": { // Grenadier
		...
		addWeapons ["ACE_M4A1_AIM_GL_F","ACE_CharliePack_Multicam"];
		addItems ["M","B","L"];
	...
	case "AR" : { // Automatic Rifleman 
		...
		addMagazines("HandGrenade_West",2);
		addMagazines("SmokeShell",2);
		addWeapons ["M249_Small","ACE_CharliePack_Multicam"];
		addItems ["M","E","L"];
	};
	case "AT": { // Rifleman AT
		addMagazines("30Rnd_556x45_Stanag",6);
		...
		_unit setVariable ["ACE_weapononback","M136"];
		addItems ["M","L"];
	};
