...
if (!isDedicated) then {
	...
	// CREW CONTROL
	crewIndex = false;
	arrRelCrew = ["US_Soldier_Pilot_EP1", "pxl_RU_Soldier_Pilot"];
	arrRelCommander = ["TU_MSV_CREW","usm_soldier_90s_w_h_crew1", "SBE_G_US_Soldier_Crew_EP1", "pxl_RU_Soldier_Crew"];
