...
switch _loadout do {
	...
	case "MG" : { 
		...
		_veh addWeaponCargo ["ACE_Earplugs",3];
	};
	...
	case "M24SD" : { 
		_veh addMagazineCargo ["TU_10Rnd_762x51_M24",10];
		_veh addMagazineCargo ["TU_10Rnd_762x51_T_M24",10];
		_veh addWeaponCargo ["ACE_Rucksack_MOLLE_Wood",2];
		_veh addWeaponCargo ["ACE_Kestrel4500",1];
		_veh addWeaponCargo ["ACE_Rangefinder_OD",1];
		_veh addMagazineCargo ["ACE_Battery_Rangefinder",5];
		_veh addWeaponCargo ["ACE_PRC119",1];
		_veh addWeaponCargo ["TU_M24A2_SD",1];
	};
