...
[_plane,veh1] execvm "scripts\supplydrop.sqf";
sleep _pause*3;
[_plane,veh2] execvm "scripts\supplydrop.sqf";
sleep _pause*3;
[_plane,veh3] execvm "scripts\supplydrop.sqf";
sleep _pause*3;
[_plane,veh7] execvm "scripts\supplydrop.sqf";
sleep _pause*3;
